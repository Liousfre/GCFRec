...
def cmdline_args():
    ...
    parser.add_argument('--device', type=str, help='PyTorch device, e.g. cpu, cuda:0, or cuda:1')
    ...
    parser.add_argument('--gcf_fusion_type', type=str,
                        choices=['sum', 'wsum', 'concat', 'gate', 'xattn'],
                        help='GCFRec fusion operator')
    parser.add_argument('--gcf_gate_mode', type=str,
